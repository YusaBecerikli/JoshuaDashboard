...
export default function ModuleCard({
  ...
  return (
    ...
    >
      <div className={`absolute top-0 left-0 w-full h-0.5 bg-gradient-to-r from-${accentColor} to-transparent opacity-0 group-hover:opacity-100 transition-opacity`} />
